...
public class Level {
    ...
    public float[] getTankNormal(int index)
    {
        return actor.getNormal(index);
    }
    
    public float[] getTankPoint(int index)
    {
        return actor.getPoint(index);
    }
    
    public boolean tankIncludes(float x, float y)
    {
        return actor.includes(x, y);
    }
    
    public int tankIndexOf(float x, float y)
    {
